    ...
    <div class="cdi-header">
        ...
        <div id="cdi-carousel-wrapper">
          <!-- TODO -->
            ...
            <p id="cdi-carousel-2" class="cdi-carousel" style="visibility: hidden; opacity:0">Sweden takes first place. Denmark is second and Finland is tied for third with Germany.</p>
            <p id="cdi-carousel-3" class="cdi-carousel" style="visibility: hidden; opacity:0">The United Kingdom takes eighth place with strengths in <em>aid</em> and <em>trade</em>. The United States takes 23rd place, with low scores on <em>environment</em> and <em>finance</em>.</p>
            <p id="cdi-carousel-4" class="cdi-carousel" style="visibility: hidden; opacity:0">South Korea comes in last overall although it is first in <em>technology</em>.</p>
...
<div class="social">
    ...
    <a href="http://twitter.com/share?text=Denmark%20takes%201st%20place%20on%20the%20Commitment%20to%20Development%20Index.%20Sweden%20and%20Finland%20are%20runners-up.&url=<?php print $url_encoded; ?>&via=cgdev" class="twitter" target="tw" title="Share on Twitter">Twitter</a>
     <a href="mailto:?subject=Commitment%20to%20Development%20Index&body=The%20Commitment%20to%20Development%20Index%20ranks%2027%20of%20the%20world%E2%80%99s%20richest%20countries%20on%20policies%20that%20affect%20the%20more%20than%20five%20billion%20people%20living%20in%20poorer%20nations.%20<?php echo $GLOBALS['base_url'].'/'.current_path();?>" target="em" class="email" title="Share by email">Email</a>
</div>
