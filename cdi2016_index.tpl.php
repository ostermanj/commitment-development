<div class="cdi-header-wrapper">
    <div class="cdi-header">
        ...
        <div id="cdi-carousel-wrapper">
            ...
            <p id="cdi-carousel-3" class="cdi-carousel" style="visibility: hidden; opacity:0">The United Kingdom takes joint seventh place with strengths in <em>aid</em> and <em>trade</em>. The United States takes 23rd place, with low scores on <em>environment</em> and <em>finance</em>.</p>
            <p id="cdi-carousel-4" class="cdi-carousel" style="visibility: hidden; opacity:0">South Korea comes in last with poor showings in <em>environment</em>, <em>trade</em>, and <em>security</em>.</p>
